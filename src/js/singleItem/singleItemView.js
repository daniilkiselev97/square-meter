                    ...
                    <div class="object">
                        ...
                        <div class="object__desc">
                            ...
                            <div class="object__desc-name">
                                ...
                                <button id='btn-fav' class="
                                    button-favourite
                                    ${isFaved ? 'button-favourite--active' : ''}     //Если isFaved - true, тогда (то есть мы добавили в избранное), то меняем на активный класс
                                    ">
...
//Собираем данные из формы для отправки после submit
export function getInput(){
    const formData = {}  //Объект для данных из формы
    formData.name = document.querySelector('#form-name').value
    formData.phone = document.querySelector('#form-phone').value
    return formData
}
//Очищаем данные с input после успешной отпраки формы
export function clearInput(){
    document.querySelector('#form-name').value = ''
    document.querySelector('#form-phone').value = ''
}
//Переключатель кнопки избранное с красного на серый
